...
class TraitDispatchTables(top: Top) {
  ...
  def initDispatch(): Unit = {
    ...
    dispatchTy = Type.Ptr
    dispatchDefn = Defn.Const(Attrs.None, dispatchName, value.ty, value, Location.None)//todo: location?
  }
  ...
  def initClassHasTrait(): Unit = {
    ...
    classHasTraitDefn =
      Defn.Const(Attrs.None, classHasTraitName, table.ty, table, Location.None)//todo: location?
  }
  ...
  def initTraitHasTrait(): Unit = {
    ...
    traitHasTraitDefn =
      Defn.Const(Attrs.None, traitHasTraitName, table.ty, table, Location.None)//todo: location?
  }
